...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { body: @fact.body, fact_id: @fact.fact_id, title: @fact.title } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { body: @fact.body, fact_id: @fact.fact_id, title: @fact.title } }
